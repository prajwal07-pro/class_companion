...
const FocusMode = () => {
  ...
  // Securely get the user ID from context rather than URL parameters
  const userId = userData?.studentId || userData?.uid || "guest";
  ...
  const handleExitEarly = () => {
    if (window.confirm("Are you sure you want to exit? Your session will be marked as incomplete.")) {
